...
//public class YardResource extends ExtendedObjectResource<Networkprovider> {
...
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(YardResource.class);
//
//    public YardResource() {
//        super(Networkprovider.class, "yardname");
//    }
//
//
//    @GET
...
//        String name = entity.getYardName();
//        Yard yard = storage.getObject(Yard.class, new Request(
//                new Columns.All(),
//                new Condition.And(
//                        new Condition.Equals("yardname", name),
//                        new Condition.Permission(User.class, getUserId(), Yard.class))));
//        return yard == null;
//    }
//
//
...
//                new Request(
//                        new Columns.All(),
//                        new Condition.Equals("networkproviderid", yardId)
//                )
//        );
//        if (!result.isEmpty()) {
//            return false;
